...
//
// Topology: 10 parallel feedback comb filters (FBCF) fed directly by the input,
...
// extended with 2 additional comb delays and 2 additional allpass delays.
//
// ROOMSIZE sets all 10 comb feedback coefficients to the same g in [0.70, 0.98]:
...
//
// MIX controls a linear dry/wet blend.  fixedgain (0.0084) scales the comb input;
...
#define REVERB_FIXEDGAIN  0.0084f // scaled down for 10 combs
...
// plus 2 additional delays continuing the spacing pattern, all < 2048.
static const unsigned reverb_comb_L[10] = { 1215, 1293, 1390, 1476, 1548, 1623, 1695, 1760,
                                             1831, 1907 };
...
// 10 combs; rates geometrically spaced (~3:2) to prevent beating; init phases
