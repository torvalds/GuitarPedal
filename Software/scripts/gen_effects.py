...
def generate(audio_dir, out_h, out_js, out_md):
    ...
    with open(out_h, 'w') as f:
        ...
        # handle_midi_packet() tests STATE_DUMP_CC before the dense_midi_map[]
        # lookup, so it has to live below the pot CC base (see cc_counter above)
        # like the other utility CCs. Otherwise it shadows whichever pot the CC
        # allocation happens to land on, and that pot becomes unreachable.
        f.write(f"#define STATE_DUMP_CC 23\n")
    ...
    with open(out_js, 'w') as f:
        ...
        f.write("const STATE_DUMP_CC = 23;\n")
