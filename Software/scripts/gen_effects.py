...
def generate(audio_dir, out_h, out_js, out_md):
    ...
    midi_channel_cc = next(
        pot['cc']
        for effect in effects_data if effect['base'] == 'settings'
        for pot in effect['pots'] if pot['label'] == 'MIDI Ch'
    )
    ...
    with open(out_js, 'w') as f:
        ...
        f.write(f"const MIDI_CHANNEL_CC = {midi_channel_cc};\n")
